...
%}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function analysis_pipeline_all_sound1_190920_correct
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
figure
subplot(1,3,1)
plot(all_correct_rate1')
set(gca,'xlim',[0 max_neuron])
set(gca,'ylim',[0.5 1])
subplot(1,3,2)
plot(S_correct_rate1')
set(gca,'xlim',[0 max_neuron])
set(gca,'ylim',[0.5 1])
subplot(1,3,3)
plot(L_correct_rate1')
set(gca,'xlim',[0 max_neuron])
set(gca,'ylim',[0.5 1])
...
plot(hist95,'b')
hold on
plot([plot_median(1),plot_median(1)],[0 10],'b')
hold on
plot([plot_median(2),plot_median(2)],[0 10],'r')
%bar(hist95)
