...
function tuning_curve_230602_sound_only_compare_block3_prefer
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[sabun_easy, median_sabun(1), p_BF_sabun(1), length_BF(1),AIC_model(1).matrix,BIC_model(1).matrix,p_AIC_BIC(1,:),easy_mouse] = ...
    plot_activity_each_neuron_230602(all_median_block_L, all_median_block_R, BF_freq, all_p_block, all_mouse_number, 1, 1);
[sabun_mid,  median_sabun(2), p_BF_sabun(2), length_BF(2),AIC_model(2).matrix,BIC_model(2).matrix,p_AIC_BIC(2,:),mid_mouse] = ...
    plot_activity_each_neuron_230602(all_median_block_L, all_median_block_R, BF_freq, all_p_block, all_mouse_number, 2, 2);
[sabun_dif,  median_sabun(3), p_BF_sabun(3), length_BF(3),AIC_model(3).matrix,BIC_model(3).matrix,p_AIC_BIC(3,:),dif_mouse] = ...
    plot_activity_each_neuron_230602(all_median_block_L, all_median_block_R, BF_freq, all_p_block, all_mouse_number, 3, 3);
...
make_tuning_curve_block_evi_230602(all_median_block_L,all_median_block_R,all_BF_neuron(:,2),sig_kruskal_sound, all_mouse_number);
