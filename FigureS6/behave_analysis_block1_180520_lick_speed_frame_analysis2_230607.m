...
----------------------------------------------------------------------------
%}
function behave_analysis_block1_180520_lick_speed_frame_analysis2_230607
...
% filename1
%Stimulus
%pathname1 = 'E:\Tone_discri1\all_mouse\behave_decode_180520\behave_decode_180520_2\stimulus';
%Reward
pathname1 = 'E:\Tone_discri1\all_mouse\behave_decode_180520\behave_decode_180520_2\reward';
cd(pathname1)
temp = dir('*.mat');
cd(currentFolder)
for i = 1:length(temp)
