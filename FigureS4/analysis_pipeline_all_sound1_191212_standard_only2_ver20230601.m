...
%}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function analysis_pipeline_all_sound1_191212_standard_only2_ver20230601
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% filename1
%pathname1 = 'E:\Tone_discri1\all_mouse\single_decode\separate4\population_190920\SVM_20200404'; %SVM
pathname1 = 'E:\Tone_discri1\all_mouse\single_decode\separate4\population_190920\integ10_EnDe_20200404'; %EnDecoding


% [filename2, pathname2,findex]=uigetfile('*.mat','Decode_20190920_opt_thre','Multiselect','on');
% filename2
pathname2 = 'E:\Tone_discri1\all_mouse\single_decode\separate4\population_190920';
...
%     figure
%     plot(all_sum_CV(:,1), all_reward, 'k.')
...
%p-value
% [median(all_behave_correct(non_nan)), median(correct_mix(non_nan)), median(correct_mix2(non_nan))]
% [median(all_behave_reward(non_nan)), median(all_all_reward(non_nan)), median(all_all_reward2(non_nan))]
% p_behave(1) = signrank(double(all_behave_correct(non_nan)), double(correct_mix(non_nan)));
% p_behave(2) = signrank(double(all_behave_correct(non_nan)), double(correct_mix2(non_nan)));
% p_behave(3) = signrank(double(correct_mix2(non_nan)), double(correct_mix(non_nan)));
% 
% p_reward(1) = signrank(double(all_behave_reward(non_nan)), double(all_all_reward(non_nan)));
% p_reward(2) = signrank(double(all_behave_reward(non_nan)), double(all_all_reward2(non_nan)));
% p_reward(3) = signrank(double(all_all_reward(non_nan)), double(all_all_reward2(non_nan)));
% 
% p_behave(1)
% p_behave(2)
% p_behave(3)
...
% p_reward(3)
% 
% [median(double(all_all_reward(non_nan))), median(double(all_all_reward2(non_nan)))]
% median(double(all_all_reward(non_nan)) - double(all_all_reward2(non_nan)))
% temp = find(all_all_reward(non_nan) < all_all_reward2(non_nan));
% [length(non_nan), length(temp)]
